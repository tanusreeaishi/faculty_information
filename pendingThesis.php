...
<body>
    ...
    <body style='background-color: #ADD8E6'>
        ...
        <h4 style="text-align:center;padding-left:35px;padding-top:35px;color: black#A9A9A9;font-size:25px;"><a href="pendingYourThesis.php">Filter Only Your Students</a></h4>
        <table class="center">
            <tr>
                <th>
            ...
            $query_run = mysqli_query($connect, "select * from student_information where thesis_status='' or thesis_status is NULL or thesis_status like '%no%'");
